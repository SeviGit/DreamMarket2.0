...
/*Este navegador es exactamemte igual que el otro , solo que uno 
es fijo en la zona de arriba y otro sgue con la página al phacer scroll y pasar el carrusel de portada*/


// Estilos TailwindCSS
const style = {
    wrapper: `hidden md:flex  backdrop-blur-md  w-full px-[1.2rem] h-[66px] lg:h-auto pt-[0.8rem] flex justify-between fuente  absolute top-0 z-50`,
    ...
    connet: `text-white text-sm px-4 py-2 border-2 border-[#02E3E2] rounded-full  hover:text-[#02E3E2] hover:bg-gray-100 hover:border-gray-100  `,
    ...
    return (
        <nav className={style.wrapper}>
            ...
            <div className='flex items-center'>
                ...
                <div className='z-50 flex items-end p-2 mb-3 ml-4 italic lg:hidden w-52 md:w-80 text-cyan-300 '>
                    <Image src={imagenes.logoPink} height={50} width={50} />
                    <div className='ml-2 text-sm tracking-wide md:text-base benyo'>DreamMarket</div>
